...
def test_load_emcee_chain():
    ...
    targetParameters = {"private": {"C_wall": {"components": [space], "x0": 1e+5, "lb": 1e+4, "ub": 1e+7},
                                    "C_air": {"components": [space], "x0": 1e+5, "lb": 1e+4, "ub": 1e+7},
                                    "C_boundary": {"components": [space], "x0": 1e+5, "lb": 1e+4, "ub": 1e+6},
                                    "R_out": {"components": [space], "x0": 0.01, "lb": 1e-2, "ub": 0.3},
                                    "R_in": {"components": [space], "x0": 0.01, "lb": 1e-2, "ub": 0.3},
                                    "R_boundary": {"components": [space], "x0": 0.01, "lb": 1e-3, "ub": 0.3},
                                    "f_wall": {"components": [space], "x0": 1, "lb": 0, "ub": 2},
                                    "f_air": {"components": [space], "x0": 1, "lb": 0, "ub": 2},
                                    "m_flow_nominal_sh": {"components": [space], "x0": 0.0202, "lb": 1e-3, "ub": 0.5},
                                    "Q_flow_nominal_sh": {"components": [space], "x0": 1000, "lb": 100, "ub": 5000},
                                    "n_sh": {"components": [space], "x0": 1.24, "lb": 1, "ub": 2},
                                    "Kp": {"components": [heating_controller], "x0": 2e-4, "lb": 1e-5, "ub": 3},
                                    "Ti": {"components": [heating_controller], "x0": 3e-1, "lb": 1e-5, "ub": 3},
                                    "m_flow_nominal": {"components": [space_heater_valve], "x0": 0.0202, "lb": 1e-3, "ub": 0.5}, #0.0202
                                    "flowCoefficient.hasValue": {"components": [space_heater_valve], "x0": 8.7, "lb": 1, "ub": 100},
                                    "dpFixed_nominal": {"components": [space_heater_valve], "x0": 1e-6, "lb": 0, "ub": 10000},
                                    "T_boundary": {"components": [space], "x0": 20, "lb": 19, "ub": 24},}}
    ...
    # DP37 case
    loaddir = os.path.join(r"C:\Users\jabj\OneDrive - Syddansk Universitet\PhD_Project_Jakob\Twin4build\python\BuildingEnergyModel\remote_results\chain_logs\chain_logs", "20240529_124010.pickle") #uniform a=5, 1-day, err=0.1 ###########################################
    loaddir = os.path.join(r"C:\Users\jabj\OneDrive - Syddansk Universitet\PhD_Project_Jakob\Twin4build\python\BuildingEnergyModel\remote_results\chain_logs\chain_logs", "20240529_192330.pickle") #uniform a=5, 1-day, err=0.1 ###########################################
    ...
    burnin = 699#int(result["chain.x"].shape[0])-3000 #100
    #########################################
