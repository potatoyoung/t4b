...
def run():
    ...
    # loaddir = r"C:/Users/jabj/OneDrive - Syddansk Universitet/PhD_Project_Jakob/Twin4build/python/BuildingEnergyModel/remote_results/chain_logs/20240810_125036.npz" #After new x0
    # model.load_estimation_result(loaddir)
    
    estimator = tb.Estimator(model)
    estimator.chain_savedir = os.path.join(uppath(os.path.abspath(__file__), 1), "generated_files", "models", "model_1st_floor", "model_parameters", "estimation_results", "chain_logs", "20240810_125036.pickle")
    ...
    options = {"n_sample": 10000, #500 #This is a test file, and we therefore only sample 2. Typically, we need at least 1000 samples before the chain converges. 
                ...
                "model_walker_initialization": "sample", #sample 
                "noise_walker_initialization": "gaussian", #gaussia
                "add_gp": True,
                "gp_input_type": "closest",
                "gp_add_time": False,
                "gp_max_inputs": 7,
                "maxtasksperchild": 30,
                "n_save_checkpoint": 20,
                "n_cores": 1
                }
