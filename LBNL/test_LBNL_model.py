...
def extend_model(self):
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_airflowrate_supply_kg_s.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_power_VI.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_FTG_MIDDEL.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_FTI1.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_FTT1.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_FTF1.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_MVV1.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_FTU1.csv")
    ...
    filename = os.path.join(os.path.abspath(uppath(os.path.abspath(__file__), 3)), "BuildingEnergyModel", "twin4build", "test", "data", "time_series_data", "VE02_FTF1.csv")
    return_waterflow_temperature_sensor = SensorSystem(
                                    measuresProperty=valve_position_property,
                                    physicalSystemFilename=filename,
                                    saveSimulationResult = True,
                                    doUncertaintyAnalysis=doUncertaintyAnalysis,
                                    id="return waterflow temperature sensor")
...
def test_LBNL_model():
    ...
    startPeriod = datetime.datetime(year=2022, month=2, day=1, hour=8, minute=0, second=0, tzinfo=tz)
    endPeriod = datetime.datetime(year=2022, month=2, day=1, hour=21, minute=0, second=0, tzinfo=tz)
    ...
    plot.plot_outdoor_environment(model=model, simulator=simulator, show=True)
